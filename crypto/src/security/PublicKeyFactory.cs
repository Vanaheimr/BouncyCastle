    ...
    public sealed class PublicKeyFactory
    {
        ...
        public static AsymmetricKeyParameter CreateKey(SubjectPublicKeyInfo keyInfo)
        {
                ...
                algOid.Equals(PkcsObjectIdentifiers.IdRsaesOaep))
            {
                ...
                var pubKey = RsaPublicKeyStructure.GetInstance(keyInfo.GetPublicKey());
            ...
            else if (algOid.Equals(OiwObjectIdentifiers.ElGamalAlgorithm))
            {
                ...
                var para  = new ElGamalParameter(Asn1Sequence.GetInstance(algID.Parameters.ToAsn1Object()));
                var derY  = (DerInteger) keyInfo.GetPublicKey();

                return new ElGamalPublicKeyParameters(derY.Value,
            ...
            else if (algOid.Equals(CryptoProObjectIdentifiers.GostR3410x2001))
            {
                ...
                var gostParams = new Gost3410PublicKeyAlgParameters((Asn1Sequence) algID.Parameters);
            ...
            else if (algOid.Equals(CryptoProObjectIdentifiers.GostR3410x94))
            {
                ...
                var algParams = new Gost3410PublicKeyAlgParameters((Asn1Sequence) algID.Parameters);
